...
use sosFSO\HrBundle\Entity\Diplome;
use sosFSO\HrBundle\Form\DiplomeType;
...
class DiplomeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sosFSOHrBundle:Diplome')->findAll();
     ...
     * @Method("POST")
     * @Template("sosFSOHrBundle:Diplome:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sosFSOHrBundle:Diplome')->find($id);
     ...
     * @Method("PUT")
     * @Template("sosFSOHrBundle:Diplome:edit.html.twig")
     */
