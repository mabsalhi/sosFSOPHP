...
use sosFSO\HrBundle\Entity\Situation;
use sosFSO\HrBundle\Form\SituationType;
...
class SituationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sosFSOHrBundle:Situation')->findAll();
     ...
     * @Method("POST")
     * @Template("sosFSOHrBundle:Situation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sosFSOHrBundle:Situation')->find($id);
     ...
     * @Method("PUT")
     * @Template("sosFSOHrBundle:Situation:edit.html.twig")
     */
