...
use sosFSO\HrBundle\Form\PersonneType;
...
class PersonneController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sosFSOHrBundle:Personne')->findAll();
     ...
     * @Method("POST")
     * @Template("sosFSOHrBundle:Personne:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sosFSOHrBundle:Personne')->find($id);
     ...
     * @Method("PUT")
     * @Template("sosFSOHrBundle:Personne:edit.html.twig")
     */
