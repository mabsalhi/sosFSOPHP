...
use sosFSO\GRHBundle\Entity\Affectation;
use sosFSO\GRHBundle\Form\AffectationType;
...
class AffectationController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sosFSOGRHBundle:Affectation')->findAll();
     ...
     * @Method("POST")
     * @Template("sosFSOGRHBundle:Affectation:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sosFSOGRHBundle:Affectation')->find($id);
     ...
     * @Method("PUT")
     * @Template("sosFSOGRHBundle:Affectation:edit.html.twig")
     */
