...
use sosFSO\GRHBundle\Entity\Service;
use sosFSO\GRHBundle\Form\ServiceType;
...
class ServiceController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('sosFSOGRHBundle:Service')->findAll();
     ...
     * @Method("POST")
     * @Template("sosFSOGRHBundle:Service:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('sosFSOGRHBundle:Service')->find($id);
     ...
     * @Method("PUT")
     * @Template("sosFSOGRHBundle:Service:edit.html.twig")
     */
