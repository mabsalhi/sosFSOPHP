 ...
 */
class Affectation extends \sosFSO\HrBundle\Entity\Affectation implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'dateAffectation', 'poste', 'dateDetachement', 'remarques', 'personne', 'service');
    }
